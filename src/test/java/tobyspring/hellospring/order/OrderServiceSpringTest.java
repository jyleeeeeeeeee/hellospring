...
public class OrderServiceSpringTest{
    ...
    @Test
    void createOrders() {
        List<OrderReq> orderReqs = List.of(new OrderReq("O200", BigDecimal.ONE), new OrderReq("O201", BigDecimal.TWO));
    ...
    void createDuplicatedOrders() {
        List<OrderReq> orderReqs = List.of(new OrderReq("O300", BigDecimal.ONE), new OrderReq("O300", BigDecimal.TWO));
